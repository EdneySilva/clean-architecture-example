...
namespace VaultApplication.Tests.Secrets.DeleteSecretCommandHandler
{
    public class Handle_Should
    {
        ...
        public async Task Execute_next_on_pipeline_when_no_errors_happens()
        {
            ...
            var handler = new VaultApplication.Secrets.Commands.DeleteSecretCommandHandler(mock.Object);
            var command = new VaultDomain.Commands.DeleteSecret.DeleteSecretCommand("user@mail.com", "pwd");
